...
import { Mail, Lock, Eye, EyeOff, User, ArrowLeft, UserPlus, Shield, ClipboardCheck } from 'lucide-react';
...
const SignupPage = ({ appLogic }) => {
    ...
    const handleSignup = async (e) => {
        ...
        setIsLoading(true);
        try {
            await appLogic.signup(form.email, form.password, form.fullName, form.username, form.role);
